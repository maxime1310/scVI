...
def show_cell_types(latent_seq, labels_seq, latent_fish, labels_fish, title='latent.svg', x_lim=[-85, 85], y_lim=[-85, 85]):
...
def show_gene_exp(latent, gene_exp, labels=None, title='latent_expression.svg', gene_name=None, x_lim=[-85, 85], y_lim=[-85, 85]):
    if labels is None:
        plt.figure(figsize=(15, 15))
